	...
	<div class="col">
		<div class="card">
			...
			<div class="card-body">
				...
				<li><strong>13th February 2019:</strong> Website updated! Began work on LioCost.
...
<div class="row">
	...
	<div class="col">
		<div class="card">
			...
			<div class="card-body">
				<h5 class="card-title">LioImage</h5>
				<p class="card-text">
	...
	<div class="col">
		<div class="card">
			...
			<div class="card-body">
				<h5 class="card-title">LioGene</h5>
				<p class="card-text">
	...
	<div class="col">
		<div class="card">
			...
			<div class="card-body">
				<h5 class="card-title">LioMart</h5>
				<p class="card-text">
